...
int Retadelta3var_driver(double *E,struct params *p,FILE *energy)
/*==============================================================================
  ...
  ============================================================================*/
{
  ...
  void scaleRetadelta3var_forward(gsl_vector *y,const struct params *p);
  
  void scaleRetadelta3var_backward(const gsl_vector *y,struct params *p);
  
  void scaleRetadelta3var_E_backward(const double F,double *E,struct params *p);
  
  void scaleRetadelta3var_dEdx_backward(const gsl_vector *dFdy,double *dEdx,struct params *p);
  ...
  do {
    ...
    scaleRetadelta3var_backward(s->x,p);
    scaleRetadelta3var_dEdx_backward(s->gradient,dEdx,p);
    *E = s->f;
  ...
  if (status == GSL_SUCCESS) {
    ...
    printf("%13s\t%13s\t%13s\t%13s\t%13s\t%13s\t%13s\t%13s\t%13s\t%13s\t%13s\n",
	   "iteration","R","R_c","eta","delta","E","dEdR","dEdeta","dEddelta",
	   "dEdR_c","grad norm");
...
void scaleRetadelta3var_dEdx_backward(const gsl_vector *dEdy,double *dEdx,struct params *p)
/*==============================================================================
