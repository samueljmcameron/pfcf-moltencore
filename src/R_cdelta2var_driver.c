...
int R_cdelta2var_driver(double *E,struct params *p,FILE *energy)
/*==============================================================================
  ...
  ============================================================================*/
{
  ...
  void scaleR_cdelta2var_forward(gsl_vector *y,const struct params *p);
  
  void scaleR_cdelta2var_backward(const gsl_vector *y,struct params *p);
  
  void scaleR_cdelta2var_E_backward(const double F,double *E,struct params *p);
  
  void scaleR_cdelta2var_dEdx_backward(const gsl_vector *dFdy,double *dEdx,struct params *p);
  ...
  scaleR_cdelta2var_forward(x_scale,p);
  ...
  do {
    ...
    scaleR_cdelta2var_backward(s->x,p);
    scaleR_cdelta2var_dEdx_backward(s->gradient,dEdx,p);
    *E = s->f;
...
double f(const gsl_vector *x_scale,void *ps)
{
  ...
  scaleR_cdelta2var_backward(x_scale,p);
...
/*==============================================================================
  ...
  ============================================================================*/
{
  gsl_vector_set(y,0,2*p->R_c/(p->R_cupper-p->R_clower)
...
/*==============================================================================
  ...
  ============================================================================*/
{
  p->R_c = 0.5*((p->R_cupper-p->R_clower)*gsl_vector_get(y,0)
...
void scaleR_cdelta2var_dEdx_backward(const gsl_vector *dEdy,double *dEdx,struct params *p)
/*==============================================================================
...
{
  dEdx[1] = 2.0/(p->R_cupper-p->R_clower)*gsl_vector_get(dEdy,1);
  dEdx[2] = 2.0/(p->deltaupper-p->deltalower)*gsl_vector_get(dEdy,0);
  return;
}
